...
4. **Caching & Rekap**:
   ...
   * Menulis rekapitulasi data seluruh foto yang sukses diproses ke file `metadata.json`.
...
├── metadata.json           # Hasil rekap metadata akhir (diabaikan oleh git)
...
3. Membuat berkas `metadata.json` yang berisi detail seluruh metadata gambar yang diproses.
